...
public class CitizenshipTests {
    ...
    public void menuNavigationTest() {
        ...
        wait.until(ExpectedConditions.textToBePresentInElementLocated(By.cssSelector("toolbar h3"), "Citizenships"));
        Assert.assertEquals(driver.findElement(By.cssSelector("toolbar h3")).getText(), "Citizenships");
    }
}
